function parametersHR = dLoad_HRsettings_kogia

%%% Filter and FFT params %%
parametersHR.bpRanges = [55000,99000]; % Bandpass filter params in Hz [min,max]
...
parametersHR.delphClickDurLims = [.2,20];% [min,max] duration in microsec 
...
parametersHR.cutPeakAboveKHz = 100; % discard click if peak frequency above Y kHz 
parametersHR.minClick_us = 16;% Minimum duration of a click in us 
parametersHR.maxClick_us = 2000; % Max duration of a click including echos
