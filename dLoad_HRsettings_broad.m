...
parametersHR.delphClickDurLims = [30,1200];% [min,max] duration in microsec 
...
parametersHR.cutPeakBelowKHz = 5; % discard click if peak frequency below X kHz
...
parametersHR.maxClick_us = 1500; % Max duration of a click including echos
